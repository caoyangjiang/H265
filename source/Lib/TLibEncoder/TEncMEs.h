...
{
 public:
  GpuMeDataAccess(Int iFrameWidth = 640,
  ...
  void Destroy();
  void InitSearchData(Int iSearchRange,
                      Int iBiPredSearchRange,
                      Int iFastSearch);
  void PreparePU(Int iPUOffset,
                 Int iPUWidth,
                 Int iPUHeight,
                 Int iRefListId,
                 Int iRefId,
  ...
  void SetSearchWindowSize(Int iSrchRngHorLeft,
